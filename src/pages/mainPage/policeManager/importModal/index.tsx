 ...
 * @LastEditTime: 2022-04-26 17:11:44
 * @LastEditors: fuzhenghao
 * @Description:
 * @FilePath: \pro1111\src\pages\mainPage\policeManager\importModal\index.tsx
 */
import React, { Component } from 'react';
import { Upload, Button, message, Row, Col } from 'antd';
import { UploadOutlined } from '@ant-design/icons';
import { policeFilesImport } from '@/commonService';
...
export default class index extends Component {
  ...
  handleUpload = () => {
    ...
    policeFilesImport(formData, (res) => {
      console.log(res);
